 ...
 *
 * Generates one premium AI illustration per storyboard scene.
 * Primary: Gemini imagen via @google/generative-ai
 * Fallback: Beautifully styled SVG scene generated programmatically
 *
 * Provider pattern: export a single `generateSceneImages(scenes)` function.
 * Future providers (Imagen 3, Stable Diffusion, Veo) can be swapped here.
 */
      ...
      contents: [
        {
          ...
          parts: [
            {
              text: `Generate a premium enterprise startup pitch presentation illustration. ${imagePrompt} Style: 16:9 widescreen, dark background (#0F172A), blue (#2563EB) accents, isometric or abstract, no text, no people faces, professional consulting aesthetic.`,
            },
          ],
        },
      ],
